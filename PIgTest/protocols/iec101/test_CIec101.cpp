...
#define TEST_FRIENDS \
    friend class TIec101_Test_readData_Fix_check_Test; \
    friend class TIec101_Test_readData_Var_check_Test; \
    friend class TIec101_Test_readData_Other_Test; \
    friend class TIec101_Test_readData_reset_Test; \
    friend class TIec101_Test_readData_TimeSynch_Test; \
    friend class TIec101_Test_readData_Iterrog_Test; \
    friend class TIec101_Test_readData_Events_Class2_Test; \
    friend class TIec101_Test_readData_Events_Class1_Test
...
class TIec101_Test: public ::testing::Test
{
...
TEST_F(TIec101_Test, setState_and_checkState)
{
...
TEST_F(TIec101_Test, setEnable)
{
    iec101->setEnable();
    ASSERT_TRUE(iec101->checkState(CIec101::STATE_READ));
}

TEST_F(TIec101_Test, setDisable)
{
    iec101->setEnable();
    iec101->setDisable();
...
TEST_F(TIec101_Test, setReadState)
{
    iec101->setReadState();
    ASSERT_TRUE(iec101->checkState(CIec101::STATE_READ));
}

TEST_F(TIec101_Test, isReadData)
{
    uint8_t min = CIec101::STATE_OFF;
    uint8_t max = CIec101::STATE_ERROR;
...
TEST_F(TIec101_Test, getNumOfBytes)
{
...
TEST_F(TIec101_Test, readData_Fix_check)
{
...
TEST_F(TIec101_Test, readData_Var_check)
{
...
TEST_F(TIec101_Test, readData_Other)
{
...
TEST_F(TIec101_Test, readData_reset)
{
...
TEST_F(TIec101_Test, readData_TimeSynch)
{
    // синхронизация часов
...
TEST_F(TIec101_Test, readData_Iterrog)
{
...
TEST_F(TIec101_Test, readData_Events_Class2)
{
    iec101->setEnable();
    iec101->setAddressLan(1);
    resetRemoteLink();
...
TEST_F(TIec101_Test, readData_Events_Class1)
{
    iec101->setEnable();
    iec101->setAddressLan(1);
    resetRemoteLink();
