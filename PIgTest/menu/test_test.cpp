...
protected:
    virtual void SetUp() override { mObj = new TTest; }
...
TEST_F(TTest_Test, setCurrentSignal_RzskHf)
{
    ...
    std::vector<testData2_t> testdata2 = { { "data00",
                                             { 0x00, 0x00, 0x01, 0x06, 0x00, 0x02 },
                                             GB_SIGNAL_OFF,
                                             "выкл.",
                                             GB_SIGNAL_CF2_NO_RZ,
                                             "КЧ2" },
                                           { "data01",
                                             { 0x04, 0x01, 0x04, 0x08, 0x01, 0xFF },
                                             GB_SIGNAL_COM1_NO_RZ,
                                             "Команда1",
                                             GB_SIGNAL_COM1_RZ,
                                             "Ком1+блок" },
                                           { "data02",
                                             { 0x04, 0x0F, 0x04, 0xFD, 0x00, 0xFF },
                                             GB_SIGNAL_COM1_NO_RZ,
                                             "Команда1",
                                             GB_SIGNAL_CF_NO_RZ,
                                             "КЧ1" } };
...
TEST_F(TTest_Test, setCurrentSignal_K400Hf)
{
    ...
    std::vector<testData2_t> testdata2 = {
        ...
        { "data01",
          ...
          "КЧ1" },
        { "data02",
          { 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x0F, 0x00, 0x00, 0xC0 },
          GB_SIGNAL_COM16,
          "Команда16",
          GB_SIGNAL_COM1,
          "Команда1" },
...
TEST_F(TTest_Test, setCurrentSignal_OptoRingUni)
{
    ...
    std::vector<testData_t> testdata = {
        { "data00",
          ...
          "выкл." },
        { "data01",
          { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_CS,
          "КС" },
        { "data02",
          { 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_RZ,
          "РЗ" },
        { "data03",
          { 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_COM1A,
          "Команда1A" },
        { "data04",
          { 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_COM2A,
          "Команда2A" },
        { "data05",
          { 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_COM21A,
          "Команда21A" },
        { "data06",
          { 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_COM32A,
          "Команда32A" },
        { "data07",
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_COM1B,
          "Команда1B" },
        { "data08",
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_COM10B,
          "Команда10B" },
        { "data09",
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_COM19B,
          "Команда19B" },
        { "data10",
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_COM32B,
          "Команда32B" },
        { "data11",
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_COM1C,
          "Команда1C" },
        { "data12",
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0xFF },
          GB_SIGNAL_COM11C,
          "Команда11C" },
        { "data13",
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0xFF },
          GB_SIGNAL_COM24C,
          "Команда24C" },
        { "data14",
        ...
        { "data15",
          { 0xEE, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF },
          GB_SIGNAL_OFF,
          "выкл." },
        { "data16",
        ...
        { "data18",
          ...
          "Команда1A" },
        { "data19",
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xE0, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF },
          GB_SIGNAL_COM14B,
          "Команда14B" },
        { "data20",
          { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xFF },
          GB_SIGNAL_COM26C,
          "Команда26C" }
    };
