...
TEST_F(TMenuPunkt_Test, change)
{
    ...
    ASSERT_TRUE(m_obj->changeName(list.at(0).c_str(), list.at(2).c_str()));
    ASSERT_TRUE(m_obj->changeName(list.at(8).c_str(), list.at(13).c_str()));
    ASSERT_TRUE(m_obj->changeName(list.at(k_max_num_punkts - 1).c_str(), list.at(17).c_str()));

    ASSERT_STREQ(list.at(2).c_str(), m_obj->getName(0));
    ASSERT_STREQ(list.at(1).c_str(), m_obj->getName(1));
    ASSERT_STREQ(list.at(7).c_str(), m_obj->getName(7));
    ASSERT_STREQ(list.at(13).c_str(), m_obj->getName(8));
    ASSERT_STREQ(list.at(9).c_str(), m_obj->getName(9));
    ASSERT_STREQ(list.at(k_max_num_punkts - 2).c_str(), m_obj->getName(k_max_num_punkts - 2));
    ...
    ASSERT_FALSE(m_obj->changeName(list.at(6).c_str(), list.at(0).c_str()));
    ASSERT_FALSE(m_obj->changeName(list.at(14).c_str(), list.at(1).c_str()));
    ASSERT_FALSE(m_obj->changeName(list.at(k_max_num_punkts - 1).c_str(), list.at(2).c_str()));
...
TEST_F(TMenuPunkt_Test, choose)
{
    ...
    ASSERT_TRUE(m_obj->choose(list.at(0).c_str(), list.at(2).c_str(), false));
    ASSERT_STREQ(list.at(2).c_str(), m_obj->getName(0));
    ASSERT_STREQ(list.at(2).c_str(), m_obj->getName(2));

    ASSERT_TRUE(m_obj->choose(list.at(0).c_str(), list.at(2).c_str(), true));
    ASSERT_STREQ(list.at(0).c_str(), m_obj->getName(0));
    ASSERT_STREQ(list.at(2).c_str(), m_obj->getName(2));

    ASSERT_TRUE(m_obj->choose(list.at(8).c_str(), list.at(13).c_str(), false));
    ASSERT_STREQ(list.at(13).c_str(), m_obj->getName(8));
    ASSERT_STREQ(list.at(13).c_str(), m_obj->getName(13));

    ASSERT_TRUE(m_obj->choose(list.at(8).c_str(), list.at(13).c_str(), true));
    ASSERT_STREQ(list.at(8).c_str(), m_obj->getName(8));
    ASSERT_STREQ(list.at(13).c_str(), m_obj->getName(13));

    ASSERT_TRUE(m_obj->choose(list.at(k_max_num_punkts - 1).c_str(), list.at(17).c_str(), false));
    ...
    ASSERT_TRUE(m_obj->choose(list.at(k_max_num_punkts - 1).c_str(), list.at(17).c_str(), true));
    ...
    ASSERT_FALSE(m_obj->choose(list.at(6).c_str(), list.at(0).c_str(), true));
    ASSERT_FALSE(m_obj->choose(list.at(14).c_str(), list.at(1).c_str(), false));
    ASSERT_FALSE(m_obj->choose(list.at(7).c_str(), list.at(8).c_str(), true));
    ASSERT_FALSE(m_obj->choose(list.at(k_max_num_punkts - 1).c_str(), list.at(2).c_str(), false));
