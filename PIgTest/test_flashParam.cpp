...
TEST_F(FlashParam_Test, gbParam_PrdDurationL)
{
    Param prop = {
        ...
        1,                        // дискретность
        1,             // множитель для стандартного протокола
        GB_SEND_INT8,  // тип параметра для сохранения новго значения                      // байт
                       // дополнительной информации для сохранения
        1,  // байт дополнительной информации для сохранения
        Param::DEPEND_MAX_NO,   // заивимость максимума
        Param::DEPEND_SAME_NO,  // зависимость повторений
        Param::CHANGE_REG_DISABLE  // условие для изменения параметра                  // байт
                                   // дополнительной информации для сохранения
    };
...
//
TEST_F(FlashParam_Test, gbParam_OtherRegime)
{
    Param prop = {
    ...
    ASSERT_TRUE(checkParam(GB_PARAM_OTHER_REGIME, prop));
}
