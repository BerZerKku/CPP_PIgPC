...
Изменения:
---> 06.09.21
	Переделана совместимость РЗСКм:
	- Клавиатура снова стала от РЗСК
	- Убраны добавленные ранее неисправности и предупреждения
	- Убраны режимы АК
	- Добавлена команда управления "Одност реж. вкл/выкл"
	- Добавлено состояние 14 для прм и защ: "Одност."
