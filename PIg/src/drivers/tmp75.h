...
class TTmp75
{
    ...
    typedef enum __attribute__((__packed__))
    {
        ...
        // received; ACK has been returned 		STATE_STX_ADR_ACK_M_ARB_LOST= 0xB0, ///<
        ...
        // been transmitted; ACK has been received 		STATE_STX_DATA_NACK			=
        ...
        // received ACK has been returned 		STATE_SRX_ADR_ACK_M_ARB_LOST= 0x68, ///<
        // Arbitration lost in SLA+R/W as Master; own SLA+W has been received; ACK has been returned
        // STATE_SRX_GEN_ACK = 0x70, ///< General call address has been received; ACK has been
        //returned 		STATE_SRX_GEN_ACK_M_ARB_LOST= 0x78, ///< Arbitration lost in SLA+R/W as
