...
//   12345678
    ...
    "БВП МК  ",   ///< версия прошивки платы БВП (Stm32)
    "ПВК МК  ",   ///< версия проишивки панели виртуальных ключей (Stm32)
    "ошибка"    ///< ошибочное значение
};
...
static const char fcGlbFault0400opto[] PROGMEM = "Нет связи с БВП";///<
...
//		 12345678901234567890
    ...
    "Нет связи с БВП",          ///< 29 кольцо
    "Восстан. связи с БВП",     ///< 30 кольцо
    "Изменение дата/время",     ///< 31
    "Изменение параметров",     ///< 32
    "Событие - %d",             ///< 33
    "Событие - %d",             ///< 34
