...
private:
     ...
     *		Содержит информацию о направлении сообщения, типе сервиса и обеспечивает защиту от потерь
     *и дублирования сообщений. При передаче от первичной станции к вторичной поле имеет вид \a
     *ControlFieldPrimary, при передаче от вторичной к первичной \a ControlFieldSecondary.
     *
